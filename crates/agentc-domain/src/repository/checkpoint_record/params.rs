...
use crate::types::{CheckpointReason, RunStatus};

#[derive(Debug, Clone, Default)]
pub struct FindCheckpointRecordParams {
...
impl FindCheckpointRecordParams {
    pub fn new() -> Self {
    ...
    pub fn run_ids(mut self, run_ids: impl IntoIterator<Item = impl Into<Uuid>>) -> Self {
        self.run_ids = Some(
            run_ids
                .into_iter()
                .map(Into::into)
...
#[derive(Debug, Clone)]
pub struct DeleteCheckpointRecordParams {
    pub tenant_id: String,
    pub ids: Vec<Uuid>,
}

impl DeleteCheckpointRecordParams {
    pub fn new(
