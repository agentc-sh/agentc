...
pub struct FindStateSnapshotParams {
...
impl FindStateSnapshotParams {
    ...
    pub fn updated_before(mut self, dt: impl Into<DateTime<Utc>>) -> Self {
        self.updated_before = Some(dt.into());
        self
    }

    pub fn updated_after(mut self, dt: impl Into<DateTime<Utc>>) -> Self {
        self.updated_after = Some(dt.into());
        self
    }
}

#[derive(Debug, Clone)]
pub struct DeleteStateSnapshotParams {
    pub tenant_id: String,
    pub ids: Vec<Uuid>,
}

impl DeleteStateSnapshotParams {
    pub fn new(
