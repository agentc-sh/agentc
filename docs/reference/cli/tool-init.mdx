...
For JavaScript, the command writes a ready-to-use package with the tool development kit, runtime
type stub reference, package metadata, and entry point already configured.
