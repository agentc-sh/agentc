...
| `prompt` | string or list | no | no | System prompt. Supports Jinja2 templates. |
...
The `prompt` field sets the agent's system prompt. It accepts either a plain string or a list of
role/content objects for multi-turn system prompts.
