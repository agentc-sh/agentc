...
Capabilities only gate tool invocation. They do not change what the runtime libraries expose to
guest code. That environment is shared across components and is described at
